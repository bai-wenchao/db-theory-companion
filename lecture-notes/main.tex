...
% right). Fonts and the fullwidth wrapper are kept identical to tufte's --
% the wrapper's adjustwidth* parity is why build.sh compiles until
% byte-stable. Chapter lines: leader + number at \normalsize (the LARGE
% title survives from the `above' arg).
