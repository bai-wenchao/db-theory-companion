...
- `./build.sh chapter <tool>` builds `main-<tool>.tex/pdf` with ONLY that
  chapter (no cover/license/ToC/ch0; book numbering kept — Theorem 2.3 here
  = Theorem 2.3 in main.pdf) for fast checks; `./build.sh main` builds the
  full book.
